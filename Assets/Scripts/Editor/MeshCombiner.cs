...
public class MeshCombiner : ScriptableWizard
{
    ...
    [MenuItem("MRK/Mesh Combine Wizard")]
    static void CreateWizard()
    {
        ScriptableWizard.DisplayWizard<MeshCombiner>("Mesh Combine Wizard");
    }
    ...
    void OnWizardCreate()
    {
        ...
        foreach (var entry in materialToMeshFilterList)
        {
            ...
            AssetDatabase.CreateAsset(combinedMesh, "Assets/Meshes/CombinedMeshes_" + materialName + ".asset");
        ...
        Object prefab = PrefabUtility.CreateEmptyPrefab("Assets/Meshes/" + resultGO.name + ".prefab");
